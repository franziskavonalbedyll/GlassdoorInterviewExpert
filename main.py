...
print(ask_question("Name three different topics that were discussed in the job interviews"))
print(ask_question("Categorize all interview questions which where asked. For each category, list 5 example questions"))